...
def get_animation_from_raw(event_id, framerate, events, tracking, custom_frames = None, show = True):
    #event_id = csv, tracking = xml
...
# This function will update the plot for each frame
    ...
    if custom_frames:
        ...
        frame_numbers = range(int(start), int(end))  # 13640 is not inclusive, so it goes up to 13639
    print(frame_numbers)

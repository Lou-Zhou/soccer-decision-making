...
value_fail_offensive = pass_value_custom.SoccerMapComponent(model = pass_value_custom.PytorchSoccerMapModel())
print("training...")
...
value_success_offensive.train(dataset_fail,model_name = 'val', batch_size = 32, trainer = {"accelerator": "cpu", "devices":1, "max_epochs": 10})
mlflow.set_experiment("pass_value/soccermap")
with mlflow.start_run() as run:
    # Log the model
...
value_success_defensive.train(dataset_total, model_name = 'val', trainer = {"accelerator": "cpu", "devices":1, "max_epochs": 10})
mlflow.set_experiment("pass_value/soccermap")
with mlflow.start_run() as run:
    # Log the model

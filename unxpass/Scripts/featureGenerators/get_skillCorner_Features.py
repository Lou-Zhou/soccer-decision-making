...
from unxpass.Scripts import get_Hawkeye_Bundesliga_Features
...
def main():
    tqdm.pandas()
    input_dir = "/home/lz80/un-xPass/unxpass/steffen/733681_Germany_Spain/"
    output_dir = "/home/lz80/rdf/sp161/shared/soccer-decision-making/SkillCorner/features"
    ...
    get_Hawkeye_Bundesliga_Features.getDummyLabels(output_dir, idxs)

...
experiment = "soccermap_offensive_completed"
overrides = [f"experiment={experiment}"]
cfg = __main__.parse_config(config_path=config_fp, overrides = overrides)
offensive = experiment.split("_")[1] == "offensive"
completed = experiment.split("_")[2] == "completed"
...
if completed:
    ...
    custom_path = f"{custom_path}_fail"

...
from unxpass.components.withSpeeds import pass_selection_speeds, pass_success_speeds
...
def main(num_to_generate = 5, custom_game = None):
    ...
    surfaces = model.predict_surface(dataset_test, model_name = "val")
    ...
    for anim in range(num_to_generate):
        ...
        animation_title = f"/home/lz80/un-xPass/unxpass/Scripts/animations/value_defensive_fail/{game_id}_{idx}_val_def.gif"

...
#feat_path = "/home/lz80/rdf/sp161/shared/soccer-decision-making/Bundesliga/all_features_outliers_fail"
feat_path = "/home/lz80/rdf/sp161/shared/soccer-decision-making/Bundesliga/all_features_outliers_success"
dataset_test = partial(PassesDataset, path = feat_path)
val_model = pass_value_speeds.SoccerMapComponent(model = pass_value_speeds.PytorchSoccerMapModel(), offensive = False)
print(val_model.initialize_dataset(dataset_test, model_name = "val").labels)
#time.sleep(10)
print("training...")
val_model.train(dataset_test, model_name = 'val', trainer = {"accelerator": "cpu", "devices":1, "max_epochs": 30})
...
#val_model_debug.train(dataset_test, model_name = 'val', trainer = {"accelerator": "cpu", "devices":1, "max_epochs": 50})

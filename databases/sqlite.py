...
class SQLiteDatabase(Database):
    ...
    def actions(self, game_id: int) -> pd.DataFrame:
        ...
        df_actions["result_id"] = df_actions["result_id"].astype(int)
        df_actions["type_id"] = df_actions["type_id"].astype(int)
        ...
        #df_actions["visible_area_360"] = [[[105.0, 0.0], [0.0, 0.0], [0.0, 68.0], [105.0, 68.0], [105.0, 0.0]]] * df_actions.shape[0]
        df_actions["in_visible_area_360"] = 1
        return df_actions

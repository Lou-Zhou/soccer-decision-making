...
db_path = "/home/lz80/rdf/sp161/shared/soccer-decision-making/buli_all.sql"
...
outputstr = f"Pass Success Model saved with run_id: {run_id}"
with open("successmodel_id.txt", "w") as text_file:

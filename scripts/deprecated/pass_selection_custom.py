...
from unxpass.components.base_custom import UnxpassComponent, UnxPassPytorchComponent, UnxPassXGBoostComponent
...
class PytorchSoccerMapModel(pl.LightningModule):
    ...
    def __init__(
        ...
        self.model = SoccerMap(in_channels=10)
...
class ToSoccerMapTensor:
    ...
    def __call__(self, sample):
        ...
        # Output
        matrix = np.zeros((10, self.y_bins, self.x_bins))#3D, 9 x 68 x 104
